    ...
    <section className='bg-red-50 '>
      <div className='mx-5 md:mx-10 lg:mx-20 2xl:mx-40'>
        <div className='flex justify-between gap-10 pt-20 relative'>
          ...
          <div className='flex flex-col gap-4 justify-center md:items-start items-center absolute md:relative bottom-5'>
            ...
            <p className='text-sm md:text-base lg:text-md 2xl:text-lg text-gray-300 md:text-gray-500 roboto md:text-justify text-center px-25 md:px-0 md:mx-0'>Discover the latest trends and express your unique style with our Women's Fashion website. Explore a curated collection of clothing, accessories, and footwear that caters to every taste and occasion.
            </p>
